	...
	<div id="comments" class="comments-wrapper">
		<?php if ( have_comments() ) : ?>
			...
			<div class="sep-text centered keep-always">
				<div class="content">
					<?php comments_number( esc_html__( '0 Comments:', 'estudiar' ), esc_html__( '1 Comment', 'estudiar' ), esc_html__( '% Comments:', 'estudiar' ) ); ?>
				</div>
			</div>
			...
			<?php if ( $ping_count ) : ?>
				<div class="sep-text centered keep-always">
					<div class="content">
						<?php echo sprintf( $ping_count > 1 ? esc_html__( '%d Trackbacks:', 'estudiar' ) : esc_html__( 'One Trackback:', 'estudiar' ), (int) (int) $ping_count );  // xss ok ?>
					</div>
				</div>
		...
		<?php
			the_comments_pagination( array(
				'prev_text' => '<span class="screen-reader-text">' . esc_html__( 'Previous', 'estudiar' ) . '</span>',
		...
		<div class="respond-box">
			<?php if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
				<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'estudiar' ); ?></p>
			<?php endif; ?>
			<?php comment_form( [
