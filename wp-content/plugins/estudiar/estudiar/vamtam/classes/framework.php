...
class VamtamFramework {
	...
	public static function theme_supports() {
		...
		function vamtam_elementor_widgets_support( bool $supports, array $args, string $feature ) {
			...
			$supported_features = [
				'nav-menu--disable-scroll-on-mobile', // Caridad-after.
				...
				'button--estudiar-underline-animation',
				...
				'posts.classic--content-hover-color',
				'posts.classic--estudiar-read-more-style',
				'testimonial-carousel--estudiar-slider-arrows',
				'testimonial-carousel--disable-slide-to-click',
				'accordion--estudiar-border-style',
				'call-to-action--estudiar-cta-style',
				'call-to-action--graphic-element-hover-color',
				'archive-posts.classic--box-section',
				'search-form--estudiar-form-style',
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'primary-menu'     => esc_html__( 'Menu Header', 'estudiar' ),
				)
			);
		}
	}
	...
	public static function load_languages() {
		load_theme_textdomain( 'estudiar', VAMTAM_THEME_DIR . 'languages' );
	}
	...
	public static function license_valid() {
		...
		esc_html_e( 'Valid Purchase Key.', 'estudiar' );
		echo '<p>';
		esc_html_e( 'Congratulations! You have succesfully registered your product.', 'estudiar' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_invalid() {
		echo '<span id="fail">';
		esc_html_e( 'Incorrect Purchase Key.', 'estudiar' );
		echo '<p>';
		esc_html_e( 'Please check your purchase code and re-enter.', 'estudiar' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_failed() {
		...
		esc_html_e( 'Cannot validate Purchase Key. Please try again later. If the problem persists your server might not have the curl PHP extension enabled.', 'estudiar' );
		echo '</span>';
	}
				...
				<div class="vamtam-notice vamtam-license-notice notice">
					...
					<div class="vamtam-notice-content">
						...
						<?php if ( $is_token ) : ?>
							...
							<?php
								echo wp_kses( sprintf( __( ' <a href="%s" target="_blank"> this link</a>', 'estudiar' ), esc_url( 'https://api.extensions.envato.com/extensions/begin_activation'
	...
	public static function token_unregistered() {
		echo '<span id="success">';
		esc_html_e('Unregistered Token.', 'estudiar');
		echo '</span>';
	}

	public static function token_unregister_fail() {
		echo '<span id="fail">';
		esc_html_e('Failed to unregister token. Please try again later. If this issue persists please contact support.', 'estudiar');
		echo '</span>';
	}

	public static function license_unregister() {
		echo '<span id="success">';
		esc_html_e( 'Unregistered Key.', 'estudiar' );
		echo '</span>';
	}
